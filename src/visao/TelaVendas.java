...
//	}
	...
	public TelaVendas(Funcionario func) {
				...
				btnConcluir.addMouseListener(new MouseAdapter() {
					...
					Float total=0f;
						...
						if(tela.getResposta()==1) {
							...
							listaItens.clear();
							dispose();
							new TelaVendas(func).setVisible(true);
						}
	...
	public void MostrarProdutos(Funcionario func){
		for (ItemVenda item : listaItens) {
			...
			btnProduto.addActionListener(new ActionListener() {
				@Override
				public void actionPerformed(ActionEvent e) {
					TelaDetalhesProduto telaDetalhes = new TelaDetalhesProduto(item,func,TelaVendas.this);
