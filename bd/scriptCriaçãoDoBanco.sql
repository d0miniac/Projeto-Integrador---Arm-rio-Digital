...
CREATE TABLE IF NOT EXISTS `armariodigital`.`vendas` (
  ...
  PRIMARY KEY (`idVenda`),
  INDEX `Funcionarios_idFuncionarios` (`Funcionario_idFuncionario` ASC) VISIBLE,
  INDEX `Cliente_idCliente1` (`Cliente_idCliente` ASC) VISIBLE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
CREATE TABLE IF NOT EXISTS `armariodigital`.`produtos` (
  ...
  INDEX `Fornecedores_idFornecedores` (`Fornecedor_idFornecedor` ASC) VISIBLE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
CREATE TABLE IF NOT EXISTS `armariodigital`.`carrinho` (
  ...
  INDEX `Vendas_idVendas` (`Venda_idVenda` ASC) VISIBLE,
  INDEX `Produtos_idProdutos` (`Produto_idProduto` ASC) VISIBLE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
